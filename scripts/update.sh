...
declare APP_NAME='www2'
declare APP_DIR="${PWD}"
declare MAKE_BASE_DIR_NAME='WWW2_BASE_DIR'
...
get_modified_file() {
  ...
  declare current_config_file="config/default.conf.template"
...
check_config_files_modifications() {
  ...
  get_modified_file "config/default.conf.template" "config/default.conf.template" "conf-file"
